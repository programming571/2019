...
public class OI {
    ...
    public JoystickButton rotatePanelPickup, rotateLowBall;
    ...
    public OI() {
        ...
        rotatePanelPickup = new JoystickButton(opStick, 1);
        rotatePanelPickup.whenPressed(new RotateTo(65));

        rotateLowBall = new JoystickButton(opStick, 2);
        rotateLowBall.whenPressed(new RotateTo(50));
