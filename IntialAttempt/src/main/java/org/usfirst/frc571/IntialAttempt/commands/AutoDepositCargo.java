...
public class AutoDepositCargo extends CommandGroup {
    ...
    addSequential(new TimedForward(1, 0, 0.8));
    
    if(station == 3) {
        /******* addSequential(new WaitCommand(1)); *******/

        // addSequential(new TimedForward(1, 0, 0.8));
        // addSequential(new CurveTo(20, 0.6, 1.5, false));
        // addSequential(new TimedForward(1, 0, 0.7));

        // addSequential(new TimedForward(1, 0, 0.7));
        // addSequential(new CurveTo(90, 0.8, 1.5, false));
        // addSequential(new CurveTo(0, 0.8, 1.5, true));
        // addSequential(new TimedForward(2,0,0.7));
        // addParallel(new RotateTo(40)); // Cargo ball level
        // addSequential(new CurveTo(-90, 0.8, 1, true));
