...
public class Robot extends TimedRobot {
    ...
    */
    chooser.addOption("AutoForward", new AutoForward());
    chooser.addOption("AutoSidePrepLeft", new AutoSidePrepLeft()); // partial auto - left side
    chooser.addOption("AutoSidePrepRight", new AutoSidePrepRight()); // partial auto - right side
    chooser.addOption("AutoDepositCargoLeft", new AutoDepositCargoLeft()); // full auto - left side
    chooser.addOption("AutoDepositCargoRight", new AutoDepositCargoRight()); // full auto - right side
    chooser.setDefaultOption("AutoForward", new AutoForward());
